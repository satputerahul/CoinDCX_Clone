...
//  CoinDCX_Clone
//
//  Created by DevMAC01 on 12/12/23.
//

import UIKit

class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "NavCell", for: indexPath) as! myCollectionViewCell
        
        cell.navImg.image = arrNavImg[indexPath.row]
        cell.navLbl.text = arrNavLbl[indexPath.row]
        cell.navLbl.adjustsFontSizeToFitWidth = true
